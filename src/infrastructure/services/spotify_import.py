...
class SpotifyImportService(BaseImportService):
    ...
    async def _fetch_data(
        ...
        **kwargs
        ...
        try:
            ...
            logger.info("Parsed Spotify export", file_path=str(file_path), count=len(play_records))
            return play_records
        except Exception as e:
            logger.error("Failed to parse Spotify export file", file_path=str(file_path), error=str(e))
    ...
    def _create_success_result(
        ...
        if hasattr(self, '_resolution_results'):
            ...
            affected_tracks = [
                Track(title="Imported Track", artists=[Artist(name="Unknown")], id=track_id)

        ...
        **kwargs
        ...
        try:
            ...
            if not raw_data:
                ...
                if progress_callback:
                    progress_callback(90, 100, "No data to import - updating checkpoints...")
                
                await self._handle_checkpoints(
                    raw_data=raw_data,
                    **kwargs
                )
            ...
            if progress_callback:
                progress_callback(80, 100, f"Saving {len(track_plays)} plays to database...")
